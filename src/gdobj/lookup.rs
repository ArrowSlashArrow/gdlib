...
pub const PROPERTY_TABLE: Map<u16, (&'static str, GDObjPropType)> = phf_map! {
    ...
    10 => ("duration / group trigger chance", GDObjPropType::Float),
    ...
    51 => ("Target item", GDObjPropType::Group),
    ...
    63 => ("Spawn delay", GDObjPropType::Float),
    ...
    95 => ("Input item 2", GDObjPropType::Item),
    ...
    102 => ("Disable preview", GDObjPropType::Bool),
    ...
    389 => ("Seconds only", GDObjPropType::Bool),
    390 => ("Special counter mode", GDObjPropType::Unknown),
    391 => ("Counter alignment", GDObjPropType::Int),
    ...
    396 => ("Directional mode distance", GDObjPropType::Int),
    ...
    441 => ("Spawn ordered", GDObjPropType::Bool),
    444 => ("No multiactivate platformer", GDObjPropType::Bool),
    ...
    478 => ("Target item type", GDObjPropType::Unknown),
    ...
    535 => ("Use control ID", GDObjPropType::Bool),
    ...
    556 => ("Spawn delay variation", GDObjPropType::Float),
    578 => ("Left sign mode", GDObjPropType::Unknown),
    579 => ("Right sign mode", GDObjPropType::Unknown),
    580 => ("Stop mode", GDObjPropType::Unknown),
    581 => ("Reset remap", GDObjPropType::Bool),
    582 => ("X velocity modifier", GDObjPropType::Float),
    583 => ("Y velocity modifier", GDObjPropType::Float),
