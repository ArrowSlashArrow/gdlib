...
pub const PROPERTY_TABLE: Map<u16, (&'static str, GDObjPropType)> = phf_map! {
    ...
    36u16 => ("Is active trigger?", GDObjPropType::Bool),
    ...
    406u16 => ("Song volume", GDObjPropType::Int),
    ...
    461u16 => ("Instant end?", GDObjPropType::Bool),
    466u16 => ("Is Timer?", GDObjPropType::Bool),
    467u16 => ("No end sound effects?", GDObjPropType::Bool),
    472u16 => ("Stop time counter?", GDObjPropType::Bool),
    473u16 => ("Event target time", GDObjPropType::Float),
